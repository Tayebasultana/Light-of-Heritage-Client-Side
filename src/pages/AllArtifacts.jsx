...
const AllArtifacts = () => {
    ...
    return (
        <div>
            {/* Tabs */}
            <Tabs>
                <TabList className="flex items-center justify-center bg-gray-100 dark:bg-gray-600 p-4 rounded-lg shadow-lg gap-4">
                    <Tab
                ...
                <TabPanel className="mt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-6 py-4 bg-gray-50 rounded-lg shadow-md">
